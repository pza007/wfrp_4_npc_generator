    ...
    def __init__(self):
        self.lvl = [
            CareerClass("Hedge Apprentice",
                        "Brass 1",
                        ['T', 'I', 'DEX'],
                        ['Channelling', 'Endurance', 'Intuition', 'Language (Magick)', 'Lore (Folklore)', 'Lore (Herbs)', 'Outdoor Survival', 'Perception'],
    ...
    def __init__(self):
        self.lvl = [
            CareerClass("Zealot",
                        "Brass 0",
                        ['WS', 'S', 'T'],
                        ['Dodge', 'Endurance', 'Heal', 'Intimidate', 'Intuition', 'Lore (Sigmar)', 'Melee (Flail)', 'Outdoor Survival'],
    ...
    def __init__(self):
        self.lvl = [
            CareerClass("Broker",
                        "Silver 1",
                        ['I', 'AG', 'FEL'],
                        ['Charm', 'Consume Alcohol', 'Dodge', 'Evaluate', 'Gamble', 'Gossip', 'Haggle', 'Melee (Basic)'],
    ...
    def __init__(self):
        self.lvl = [
            ...
            CareerClass("Grave Robber",
                        "Brass 3",
                        ['WS'],
                        ['Drive', 'Bribery', 'Evaluate', 'Haggle', 'Lore (Medicine)', 'Melee (Basic)'],
